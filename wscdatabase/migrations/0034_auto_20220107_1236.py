# Generated by Django 3.2 on 2022-01-07 17:36
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('wscdatabase', '0033_alter_currentrm_increase'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='totals',
            name='totalincrease',
            field=djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=Decimal('0.00'), default_currency='USD', max_digits=14, null=True, verbose_name=''),
        ),
        migrations.AddField(
            model_name='totals',
            name='totalincrease_currency',
